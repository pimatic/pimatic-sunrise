...
is used to define which sunlight times related attributes shall be exposed by the device. The name given for an 
attribute is one of the event names listed above.
